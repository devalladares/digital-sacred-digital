...
const ambientCol = ['#b8faf6'];
const ambientColRan = Math.floor(Math.random() * ambientCol.length);

const hemCol = ['#18d8ae'];
const hemColRan = Math.floor(Math.random() * hemCol.length);

const dirCol = ['#d2a7b9'];
const dirColRan = Math.floor(Math.random() * dirCol.length);
...
const cols = {
  color1: ambientCol[ambientColRan],
  color2: hemCol[hemColRan],
  color3: 0x00ff00,
  color4: dirCol[dirColRan]
}
...
hemLight = new THREE.HemisphereLight('blue', 'red', 0.5)
